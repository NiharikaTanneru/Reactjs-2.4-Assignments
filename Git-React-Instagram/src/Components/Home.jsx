...
class Home extends React.Component {
  ...
  <i class="circular search link icon"></i>
      ...
      <div className="group">
        ...
        <UserStory name="Padmasri"
         img="https://cdn.pixabay.com/photo/2016/03/23/04/01/woman-1274056__340.jpg"/>
        <UserStory name="Ramesh" 
        img="https://media.istockphoto.com/id/1323167284/photo/young-successful-indian-man-wearing-stylish-eyeglasses-standing-on-the-street-handsome-asian.jpg?b=1&s=170667a&w=0&k=20&c=dAYCdnHkGyMP38WuwncFJT9Zfeegun1tf41Xtzuc0uc="/>
